...
function constructDateRangeCustom(params) {
  ...
  if (granularity === 'month') {
    ...
    console.warn('odoo_jalaali > search > utils > dates > constructDateRangeCustom(): Invalid granularity:', granularity)
    ...
    switch (option.granularity) {
      ...
      case "year": {
        ...
        if (option.format === 'MMMM') {
          ...
          console.warn('odoo_jalaali > search > utils > dates: Unknown format:', option.format)
...
odoo.define('odoo_jalaali.search.utils.dates', [], function (require) {
