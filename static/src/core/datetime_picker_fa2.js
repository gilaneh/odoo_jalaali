...
const jalaaliDate = (date) => {
        if (session.user_context.lang == 'fa_IR' && date.year < 1600){
            ...
            date = DateTime.fromString(`${gDate.gy}-${gDate.gm}-${gDate.gd} date.hour:date.minute:date.second`, JALAALI_DataTime_FORMAT)
        }
        return date
    }
...
//        referenceDate = jalaaliDate(referenceDate)
//        console.log('referenceDate2', referenceDate, getterParams )
